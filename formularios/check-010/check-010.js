const checklistItems = [
    { section: 'DOCUMENTOS', items: ['Padrón', 'Permiso de Circulación', 'Revisión Técnica', 'Seguro Obligatorio', 'Póliza Seguro', 'Ultima Mantención', 'Tabla de cargas']},
    ...
    { section: 'GENERAL PLUMA', items: ['Estabilizador (F.I.)', 'Estabilizador (F.D.)', 'Estabilizador (T.I.)', 'Estabilizador (T.D.)', 'Brazo Giratorio', 'Escaleras de acceso', 'Control joystick', 'Estado canasto', 'Comandos Torre', 'Sistema Hidráulico']}
];
